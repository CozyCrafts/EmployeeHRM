...
Partial Class Performance_Review
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Performance_Review))
        Panel1 = New Panel()
        ...
        Label2.Name = "Label2"
        Label2.Size = New Size(343, 34)
        Label2.TabIndex = 0
        Label2.Text = "Performance Review"
        ' 
        ' Performance_Review
        ' 
